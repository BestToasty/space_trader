...
pub enum Commands {
    ...
    GetWaypointCoordinates { waypoint_symbol: Option<String> },
    GetStartingWaypointSymbol {},
    FindClosestSystemShipyard { waypoint_symbol: Option<String> },
    GetShipyard { waypoint_symbol: Option<String> },
    GetSystem { system_symbol: Option<String> },
}
